(window["webpackJsonp"]=window["webpackJsonp"]||[]).push([["chunk-25a04dbd"],{1869:function(e,t,n){},"24ee":function(e,t,n){"use strict";var r=n("7ded"),s=n("589b"),o=n("1fd5"),i=n("22e5");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fe(e){let t;try{t=JSON.parse(e)}catch(n){return null}return j(t)?t:null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct{constructor(e,t){this._service=e,this._location=t instanceof A?t:A.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new ct(e,t)}get root(){const e=new A(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return me(this._location.path)}get storage(){return this._service}get parent(){const e=pe(this._location.path);if(null===e)return null;const t=new A(this._location.bucket,e);return new ct(this._service,t)}_throwIfRoot(e){if(""===this._location.path)throw C(e)}}function ut(e,t,n){return e._throwIfRoot("uploadBytesResumable"),new at(e,new _e(t),n)}function lt(e){const t={prefixes:[],items:[]};return ht(e,t).then(()=>t)}async function ht(e,t,n){const r={pageToken:n},s=await dt(e,r);t.prefixes.push(...s.prefixes),t.items.push(...s.items),null!=s.nextPageToken&&await ht(e,t,s.nextPageToken)}function dt(e,t){null!=t&&"number"===typeof t.maxResults&&D("options.maxResults",1,1e3,t.maxResults);const n=t||{},r=Ne(e.storage,e._location,"/",n.pageToken,n.maxResults);return e.storage.makeRequestWithTokens(r,it)}function _t(e){e._throwIfRoot("getMetadata");const t=Fe(e.storage,e._location,ke());return e.storage.makeRequestWithTokens(t,it)}function ft(e,t){e._throwIfRoot("updateMetadata");const n=De(e.storage,e._location,t,ke());return e.storage.makeRequestWithTokens(n,it)}function pt(e){e._throwIfRoot("getDownloadURL");const t=$e(e.storage,e._location,ke());return e.storage.makeRequestWithTokens(t,it).then(e=>{if(null===e)throw U();return e})}function gt(e){e._throwIfRoot("deleteObject");const t=ze(e.storage,e._location);return e.storage.makeRequestWithTokens(t,it)}function mt(e,t){const n=ge(e._location.path,t),r=new A(e._location.bucket,n);return new ct(e.storage,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
